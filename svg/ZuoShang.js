...
class ZuoShang extends Component {
   ...
   render() {
      return (
            <Svg id="zuoshang" x="0" y="0" viewBox={"0 0 "+(this.props.s*parseInt(15*w))+" "+(this.props.s*parseInt(48*w))} width={this.props.s*parseInt(15*w)} height={this.props.s*parseInt(48*w)} version="1.1">
