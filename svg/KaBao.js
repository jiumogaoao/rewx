...
class KaBao extends Component {
   ...
   render() {
      return (
            <Svg t="1498714245102" class="icon" style="" p-id="704" viewBox={"0 0 "+(this.props.s*1024)+" "+(this.props.s*1024)} version="1.1" width={this.props.s*parseInt(1024*w)} height={this.props.s*parseInt(1024*w)}>
