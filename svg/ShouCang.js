...
class ShouCang extends Component {
   ...
   render() {
      return (
            <Svg t="1498700772317" class="icon" style="" viewBox={"0 0 "+(this.props.s*parseInt(1024*w))+" "+(this.props.s*parseInt(1024*w))} version="1.1" p-id="14103" width={this.props.w} height={this.props.h}>
