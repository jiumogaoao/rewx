...
class Detail extends Component {
  ...
  svg:{
   ...
   {this.props.navigation.state.params.type==0?(
      <Text style={{color:'#fff',backgroundColor:'transparent',textAlign:'center',fontSize:parseInt(40*w),lineHeight:parseInt(70*w)}}>添加好友</Text>
):(
      <Text style={{color:'#fff',backgroundColor:'transparent',textAlign:'center',fontSize:parseInt(40*w),lineHeight:parseInt(70*w)}}>发送消息</Text>
)}
    </View>
    </View>
         );
