  ...
  svg:{
   ...
   render() {
     ...
     {data: [
      ...
      {name:"表情", key: 'CCCC',dsc:'cc',other:(<View style={{marginTop:parseInt(16*w),
    marginLeft:parseInt(5*w),backgroundColor:"#f9ca08",borderRadius:parseInt(40*w),width:parseInt(45*w),height:parseInt(45*w)}}><Icon name="biaoqing" style={[this.styles.icon,{color:"#fff",backgroundColor:"transparent",marginLeft:0,marginTop:0}]}/></View>)}
      ], key: 'C'},
