...
class Wallet extends Component {
  constructor(props) {
            ...
            this.style = StyleSheet.create({
              headIcon:{
                color:'#fff',textAlign:'center',fontSize:parseInt(67*w),lineHeight:parseInt(67*w),marginTop:parseInt(62*w),height:parseInt(75*w)
              },
              headText:{
  ...
  static navigationOptions = ({ navigation }) => {
   ...
   ]} contentContainerStyle={{flexDirection: 'row',flexWrap: 'wrap',backgroundColor: '#FFFFFF'}}/>
         );
   }
}
