            ...
            <View style={[{borderRadius:parseInt(5*w),position:"relative",maxWidth:parseInt(300*w)},this.props.data.from==1?{marginRight:parseInt(5*w),backgroundColor:"#a2e758"}:{marginLeft:parseInt(5*w),backgroundColor:"#fff"}]}>
                ...
                {this.props.data.from==1?(
                  <View style={{position:"absolute",top:0,right:0,height:"100%",flexDirection:"column",zIndex:3}}>
                    ...
                    <View style={{flex:1,backgroundColor:"#EBEBEB",width:parseInt(8*w),marginLeft:'auto',borderLeftColor:"#D4D4D4",borderLeftWidth:0.4}}/>
                  ...
                  <View style={{height:parseInt(33*w),width:parseInt(13*w),marginTop:-1}}><ZuoShang s={0.05}/></View>
                  <View style={{flex:1,width:parseInt(9*w),backgroundColor:"#EBEBEB",borderRightColor:"#D4D4D4",borderRightWidth:0.4,minHeight:1}}/>
